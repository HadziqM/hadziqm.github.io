...
export default function Card(prop: Props) {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex flex-col items-center justify-between gap-2 rounded-lg w-[300px] h-[465px] transition-[background-color] duration-200 cursor-pointer z-50"
      style={{
        background: hover ? "rgba(100,100,255,0.2)" : "rgba(0,0,0,0.9)",
      }}
      animate={control}
